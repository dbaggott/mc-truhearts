...
**TrueHearts** prints the real number, in red, right above your heart bar.
...
- **You can see when small damage actually hit you.** Fire ticks, magic damage, environmental wear — the heart pips snap to half-hearts and lose the in-between numbers. TrueHearts shows you the exact `0.42` your shield just absorbed.
